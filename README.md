...
التسجيل العام متوقف. يضغط صاحب المتجر على زر طلب الدعوة ويملأ نموذجًا داخل الموقع، ثم يصل الطلب مباشرة إلى بريد المالك `azizhail1212@gmail.com` دون فتح Outlook. خدمة FormSubmit قد تطلب تأكيد البريد عند أول إرسال. بعد مراجعة الطلب، ينشئ المالك دعوة من Supabase عبر `Authentication → Users → Add user → Invite user`.
